...
import activity.MediaPlayerIntentServiceActivity;
import jdo.MediaJdo;
import listener.SeekToServiceListener;
import listener.boundservicelistener.SendPlayPauseEventListener;

public class MediaPlayerIntentServiceFragment extends Fragment implements SeekToServiceListener {
    ...
    public MediaPlayerIntentServiceFragment(Context pContext, MediaJdo pMediaJdo) {
        mMediaJdo = pMediaJdo;
        mContext = pContext;
    }
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if(context instanceof MediaPlayerIntentServiceActivity){
            mPlayorpauseEvent= (SendPlayPauseEventListener) context;
        }
    }

    @Override
    public void seekTo(int pCurrentPosition) {
