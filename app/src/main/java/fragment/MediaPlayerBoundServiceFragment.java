...
import listener.boundservicelistener.LoopAndShuffleEvent;
...
public class MediaPlayerBoundServiceFragment extends Fragment implements  UpdateProgressinFragmentListener {
    ...
    public MediaPlayerBoundServiceFragment(Context pContext, MediaJdo pMediaJdo) {
        mMediaJdo = pMediaJdo;
        mContext = pContext;
    }
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (context instanceof MediaPlayerBoundActivity) {
